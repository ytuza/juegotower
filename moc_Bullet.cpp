...
QT_MOC_LITERAL(4, 25, 10), // "getDistRec"
QT_MOC_LITERAL(5, 36, 9), // "rango_alc"
QT_MOC_LITERAL(6, 46, 3), // "rng"
QT_MOC_LITERAL(7, 50, 10), // "setDistRec"
QT_MOC_LITERAL(8, 61, 4) // "dist"

    },
    "Bullet\0move\0\0getMaxRange\0getDistRec\0"
    "rango_alc\0rng\0setDistRec\0dist"
};
...
void Bullet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { double _r = _t->getDistRec();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = _r; }  break;
        case 3: _t->rango_alc((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 4: _t->setDistRec((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}
